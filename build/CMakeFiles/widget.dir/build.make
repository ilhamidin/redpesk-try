...
CMakeFiles/widget: modem-binding-debug.wgt


modem-binding-debug.wgt: gpiod-mlk/afb-modem-bindingv3.so
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/administrator/Documents/redpesk-try/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating modem-binding-debug.wgt"
	/usr/bin/zip -f -o modem-binding-debug.wgt /home/administrator/Documents/redpesk-try/build/package

widget: CMakeFiles/widget
widget: modem-binding-debug.wgt
widget: CMakeFiles/widget.dir/build.make
	/usr/bin/cmake -E cmake_echo_color --cyan ++\ Install\ widget\ file\ using\ in\ the\ target\ :\ afm-util\ install\ modem-binding.wgt
.PHONY : widget
